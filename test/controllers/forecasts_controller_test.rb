...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post forecasts_url, params: { forecast: { city: @forecast.city, precipitation: @forecast.precipitation, temp_max: @forecast.temp_max, temp_min: @forecast.temp_min, user: @forecast.user } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { city: @forecast.city, precipitation: @forecast.precipitation, temp_max: @forecast.temp_max, temp_min: @forecast.temp_min, user: @forecast.user } }
